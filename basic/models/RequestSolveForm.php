 ...
 */
class RequestSolveForm extends Request
{
    ...
    {
        return [
            [['photoAfter'], 'required', 'message' => 'Нужно заполнить поля'],
//            [['description', 'status', 'reason'], 'string'],
//            [['timestamp'], 'safe'],
//            [['idUser', 'idCategory', 'maxprice'], 'integer'],
            ['photoAfter', 'file', 'extensions' => 'png, jpg, jpeg, bmp', 'maxSize' => 2 * 1024 * 1024, 'message' => 'Только png, jpg, jpeg, bmp с размером 2 МБ'],
